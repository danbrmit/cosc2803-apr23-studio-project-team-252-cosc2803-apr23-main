      ...
      try {
         ...
         while (lineScanner.hasNext()) {
            ...
            while (rowScanner.hasNext()) {
               ...
               String query = "UPDATE CountryTempObservation"
            ...
            // String landOceanAvg = rowScanner.next();
            // String landOceanMin = rowScanner.next();
            // String landOceanMax = rowScanner.next();
            ...
            // Some error handling
            // if (landOceanAvg.equals("")) {
            //    landOceanAvg = "0";
            // }
            // if (landOceanMax.equals("")) {
            //    landOceanMax = "0";
            // }
            // if (landOceanMin.equals("")) {
            //    landOceanMin = "0";
            // }
            ...
            // // Create Insert Statement
            // String query = "INSERT into GlobalTempObservation VALUES ("
            //          + year + ","
            //          + avgTemp + ","
            //          + minTemp + ","
            //          + maxTemp + ","
